...
function LoanRequests() {
    ...
    <div className="">
        <div className='bg-[#373737] rounded-md px-2 py-3'>
            <h2 className='text-white font-bold'>Loan Requests</h2>
        </div>
        <div >
            ...
            }
            {
                ...
                <div className='border my-2 px-2 py-2 rounded text-sm font-bold text-white bg-red-600'>No Loan Requests Found</div>
            }
            {status === 'succeeded' && loanRequests.length > 0 && (
                <div>
                    <Pagination
