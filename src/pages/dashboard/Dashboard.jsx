    ...
    <div className='bg-[#373737] rounded-md px-2 py-4'>
      ...
      <div className='flex gap-x-6'>
        ...
        <div className="flex flex-col w-1/2 ">
            <div className="flex  flex-col gap-2 p-4  bg-clip-border rounded-xl w-3/3 bg-white text-gray-700 border border-blue-gray-100 shadow-sm ">
            ...
            <div className="flex justify-between items-center p-4 bg-clip-border rounded-xl w-3/3 bg-white text-gray-700 border border-blue-gray-100 shadow-sm ">
            <p className="text-xl"><FontAwesomeIcon className="size-6" icon={faLocationDot} /> Recovered: 90%</p><progress value={75} max={100} />
            </div>
